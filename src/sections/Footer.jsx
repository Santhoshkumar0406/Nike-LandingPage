    ...
    <footer className="max-container">
      <div className="flex justify-between items-start gap-20 flex-wrap max-lg:flex-col">
        <div className="flex flex-col items-start">
          ...
          <p className='mt-6 text-base leading-7 font-monsterrat text-white-400 sm:max-w-sm'>Get shoes ready for the new term at your nearest Nike store. Find Your perfect Size In Store. Get Rewards</p>
        ...
        <div className='flex flex-1 justify-between lg:gap-10 gap-20 flex-wrap'>
          {footerLinks.map((section) => (
            <div>
              <h4 className='text-white font-monsterrat text-2xl leading-normal font-medium mb-6'>
                {section.title} 
              </h4>
              <ul>
